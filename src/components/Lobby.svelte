...
<div class="lobby-container">
  <!-- Settings Buttons (Corners) -->
  <button class="settings-btn top-left" onclick={openSettings} title="Settings" aria-label="Settings">{@html GearIcon}</button>
  <button class="settings-btn top-right" onclick={openSettings} title="Settings" aria-label="Settings">{@html GearIcon}</button>
  <button class="settings-btn bottom-left" onclick={openSettings} title="Settings" aria-label="Settings">{@html GearIcon}</button>
  <button class="settings-btn bottom-right" onclick={openSettings} title="Settings" aria-label="Settings">{@html GearIcon}</button>
...
<style>
  ...
  */
  ...
  .top-left { top: 2rem; left: 2rem; transform: rotate(135deg); }
  .top-right { top: 2rem; right: 2rem; transform: rotate(-135deg); }
  .bottom-left { bottom: 2rem; left: 2rem; transform: rotate(45deg); }
  .bottom-right { bottom: 2rem; right: 2rem; transform: rotate(-45deg); }
</style>
