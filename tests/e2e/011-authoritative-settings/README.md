...
## Every gameplay constant has a visible control

![Every gameplay constant has a visible control](screenshots/000-all-rules-configured.png)

**Specs:**
- All thirteen rule settings are represented
...
![The game is created from the configured rules snapshot](screenshots/001-configured-game-created.png)
...
![Tabletop actions use the same configured limits](screenshots/002-tabletop-rules-applied.png)
...
![The private hand receives the game rules snapshot](screenshots/003-private-hand-rules-applied.png)
